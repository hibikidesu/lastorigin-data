...
Target = 0
	...
	-- 중장형 타겟
    if CreatureAI.IsApplyBuff("Effect_MP_Tyrant_N_3") == 1 or CreatureAI.IsApplyBuff("Effect_MP_Tyrant_N_33") == 1 then
					
       Target = 1
	   
	   if CreatureAI.IsApplyBuff("Effect_MP_Tyrant_N_15") == 1 then
	   ...
	   --경장형 타겟
	   if CreatureAI.IsApplyBuff("Effect_MP_Tyrant_N_31") == 1 or CreatureAI.IsApplyBuff("Effect_MP_Tyrant_N_34") == 1 then
	   ...
	   Target = 2
		...
		SubProcess()
			...
			--기동형 타겟
			if CreatureAI.IsApplyBuff("Effect_MP_Tyrant_N_32") == 1 or CreatureAI.IsApplyBuff("Effect_MP_Tyrant_N_35") == 1 then
