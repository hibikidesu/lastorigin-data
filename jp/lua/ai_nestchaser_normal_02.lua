...
function Process()
	...
	if CreatureAI.IsApplyBuff("Effect_MP_NestChaser_TU2_4") == 1 and 70 <= CreatureAI.GetRandomValue(100) then			
		...
		if CreatureAI.IsApplyBuff("Effect_MP_NestChaser_TU2_41") == 1 and 55 <= CreatureAI.GetRandomValue(100) then
			...
			if CreatureAI.IsApplyBuff("Effect_MP_NestChaser_TU2_42") == 1 and 45 <= CreatureAI.GetRandomValue(100) then
